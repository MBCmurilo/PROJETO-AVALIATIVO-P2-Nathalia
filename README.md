...
Python Streamlit Scikit-learn Pandas NumPy Machine Learning
...
Formulário de predição Resultado da predição
...
Importância das variáveis Métricas do modelo Descrição das variáveis
